...
const NoProductAvailable = ({
  ...
  return (
    ...
    >
      ...
      >
        Xin lỗi, nhưng không có sản phẩm phù hợp với{" "}
      ...
      >
        ...
        <span>Chúng tôi sẽ cập nhật sản phẩm sớm</span>
      </motion.div>
      ...
      >
        Vui lòng kiểm tra lại sau hoặc khám phá các danh mục sản phẩm khác.
      </motion.p>
    </div>
  );
};
